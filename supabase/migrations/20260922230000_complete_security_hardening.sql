...
-- Remove the legacy global lockout row before installing the stricter
-- per-IP key constraint. Otherwise an existing row would make the
-- constraint creation fail and leave the new lockout RPCs unavailable.
